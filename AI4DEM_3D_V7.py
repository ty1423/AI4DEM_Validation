...
vx_grid[0, 0, 10, 10, 10] = 20
vy_grid[0, 0, 10, 10, 10] = 20
vz_grid[0, 0, 10, 10, 10] = 20

'''
x_grid[0, 0, 12, 10, 10] = 10 * cell_size
y_grid[0, 0, 12, 10, 10] = 10 * cell_size
z_grid[0, 0, 12, 10, 10] = 12 * cell_size
'''
...
with torch.no_grad():
 ...
 #           ax = fig.add_subplot(111)
  ...
  #             sc = ax.scatter(xp, zp, c=vy_grid[vy_grid != 0].cpu(), cmap="turbo", s=S_graph, vmin=-40, vmax=40)
  #             sc = ax.scatter(xp, yp, c=vy_grid[vy_grid != 0].cpu(), cmap="turbo", s=S_graph, vmin=-40, vmax=40)
